...
# this grammar is a little bit slack on string delimiters, 
# i.e. it will parse both "a string" and "a string'
# and also it's a bit slack on a definition of what is a string
JSON = grammar(r"""value => false | null | true | object | array | number | string
object => [{] members [}] | [{] [}]
